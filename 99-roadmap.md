...
| Geofuncties      | Foi format=                                    | Het nieuwe Foi-endpoint krijgt een attribuut (format=geojson) die exporteerd in GeoJSON FeatureCollection, rekening houdend met de OData $filter | Gepland                 |
